import {
    ...
    ScreenSpaceEventHandler, Cesium3DTileFeature, viewerCesium3DTilesInspectorMixin
} from "cesium";
...
const tileset_buildings = viewer.scene.primitives.add(new Cesium3DTileset({
    // url: 'https://3d.kadaster.nl/3dtiles/2020/Gebouwen/tileset.json',
    url: 'http://localhost:8003/tileset.json',
    // url: 'https://data.3dgi.xyz/3dtiles-test-data/tilesets/buildings/tileset.json',
    // url: 'https://godzilla.bk.tudelft.nl/tyler_debug/tileset.json',
