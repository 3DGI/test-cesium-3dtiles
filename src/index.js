...
Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI4ODkzZjUyOC1iZWEzLTQxZGItYTA3ZC1hYmY2YmE0MzI0NzQiLCJpZCI6OTUzMiwiaWF0IjoxNzQ5NzI4MTUwfQ.G9xdBtrKP7WnLhZzfQd6dfAIpKu2VcU1-HbvZROGMzw';
...
var credit = new Credit('3D Tiles generated by <a href="https://3dgi.nl/" target="_blank">3DGI</a> for <a href="https://www.kadaster.nl/">the Dutch Kadaster</a>.', true);

// viewer.extend(viewerCesium3DTilesInspectorMixin);
// const inspectorViewModel = viewer.cesium3DTilesInspector.viewModel;

//"http://https://godzilla.bk.tudelft.nl/tyler_debug/tileset.json",
try {
    const tileset_buildings = await Cesium3DTileset.fromUrl(
    ...
    viewer.scene.primitives.add(tileset_buildings);
} catch (error) {
...
//     url: 'http://localhost:8004/tileset.json',
...
viewer.camera.setView({
    destination: Cartesian3.fromDegrees(6.55151, 52.33512, 100),
    // destination: Cartesian3.fromDegrees(4.35667,51.98129, 500),
    orientation: {
        heading: Math.toRadians(0.0), // east, default value is 0.0 (north)
        pitch: Math.toRadians(-5),    // default value (looking down)
